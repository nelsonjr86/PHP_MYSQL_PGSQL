...
?>
            <tr><td><?=$reg->cliente?></td>
            <td><?=$reg->nome?></td>
            <td><?=$reg->email?></td>
            <td><?=$reg->data_nasc?></td>
            <td><?=$reg->cpf?></td>
            <td><a href="update.php?cliente=<?=$reg->cliente?>"><i class="glyphicon glyphicon-edit" title="Editar"></a></td>
            <td><a href="delete.php?cliente=<?=$reg->cliente?>"><i class="glyphicon glyphicon-remove-circle" title="Excluir"></a></td></tr>
<?php
       }
       print '</table>';
print '</div>';
