...
?>
            <td><a href="update.php?cliente=<?=$row['cliente']?>"><i class="glyphicon glyphicon-edit" title="Editar"></a></td>
            <td><a href="delete.php?cliente=<?=$row['cliente']?>"><i class="glyphicon glyphicon-remove-circle" title="Excluir"></a></td></tr>
<?php
		}
	}
	?>
